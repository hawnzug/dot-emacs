...
Prevent package.el activating packages.
#+BEGIN_SRC elisp
...
* package setup
Use the builtin use-package since it is a rather stable package.
#+BEGIN_SRC elisp
  (require 'use-package)
#+END_SRC
...
* theme
Avoid annoying extra confirmations when tweaking themes.
#+BEGIN_SRC elisp
