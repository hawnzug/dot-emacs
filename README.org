...
#+BEGIN_SRC elisp
  (defun my:font-setup ()
    (let ((primary-font
      ...
      (set-face-font 'variable-pitch "Merriweather 16")))
...
#+BEGIN_SRC elisp
  (use-package bookmark
    :commands (bookmark-set bookmark-jump))
#+END_SRC
...
#+BEGIN_SRC elisp
  ...
  (use-package counsel
    :ensure t
    :commands (counsel-M-x counsel-find-file counsel-switch-buffer))
#+END_SRC
...
#+BEGIN_SRC elisp :tangle no
  (general-def 'normal lsp-ui-imenu-mode-map
