...
** hydra-global
   #+BEGIN_SRC elisp
     ...
     _d_: dired     _m_: Email     _B_: buffer     _l_: link
   ...
   #+BEGIN_SRC elisp
     (use-package org-gcal
       ...
       (setq org-gcal-client-id
             (shell-command-to-string "gpg -q -d ~/mail/passwords/gcal-id.asc"))
       (setq org-gcal-client-secret
             (shell-command-to-string "gpg -q -d ~/mail/passwords/gcal-secret.asc"))
       (setq org-gcal-file-alist
             '(("wang9163@umn.edu" .  "~/org/schedule.org"))))
   #+END_SRC
** org capture
  Org capture templates.
