...
* init
  ...
  #+BEGIN_SRC elisp
    ...
    (set-face-attribute 'fixed-pitch nil :family "Iosevka Type Slab 12")
    (set-face-attribute 'fixed-pitch-serif nil :family "Iosevka Type Slab 12")
    (set-face-attribute 'variable-pitch nil :family "EB Garamond 12")
  #+END_SRC
