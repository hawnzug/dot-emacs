...
** hydra-global
   #+BEGIN_SRC elisp
     ...
     ─────────────────────────
     _b_: buffer    _g_: magit     _E_: eyebrowse  _e_: eshell
     _f_: file      _a_: agenda    _w_: window     _v_: vterm
     _s_: swiper    _m_: Email     _B_: buffer     _l_: link
     _d_: dired     _[_: Side      _h_: help       _c_: capture
