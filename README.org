...
** hydra-global
   #+BEGIN_SRC elisp
     ...
     _f_: file      _a_: agenda    _w_: window     _c_: capture
     _s_: swiper    _A_: Agenda    _B_: buffer     _q_: quit
     _d_: dired     ^ ^            _h_: help       _Q_: Quit
     _r_: ripgrep   ^ ^            _p_: project    _M-,_: other
     _k_: kill
     _i_: ibuffer
...
* org
  #+BEGIN_SRC elisp :noweb no-export
    (use-package org
      ...
      <<org-agenda-config>>
      <<org-clock-config>>
      (add-to-list 'Info-additional-directory-list "~/Projects/org-mode")
