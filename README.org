...
* init
  ...
  #+BEGIN_SRC elisp
    (defun my:font-setup ()
      ...
      (set-face-font 'variable-pitch primary-font)))
...
** org-agenda
  ...
  #+BEGIN_SRC elisp :noweb no-export
    (use-package org-agenda
      ...
      :commands (org-agenda)
      :config
      (setq org-agenda-files '("~/org/orz.org"))
...
** emacs-libvterm
   #+BEGIN_SRC elisp
     (use-package vterm
       :load-path "~/.config/emacs/packages/emacs-libvterm")
   #+END_SRC
...
#+BEGIN_SRC elisp
  (use-package ivy-bibtex
    ...
    (setq bibtex-completion-notes-path "~/org/read.org")
