...
(let ((color-bg "#ffffff")
  ...
  (custom-theme-set-faces
   ...
   `(window-divider ((t (:foreground ,light-blue-900 :background ,color-bg))))
   ...
   `(show-paren-match ((t (:foreground ,color-bg :background ,light-blue-500))))
   ...
   `(outline-1 ((t (:foreground ,color-fg :weight bold))))
