...
(let ((bg "#fafafa")
  ...
  (custom-theme-set-faces
   'lowlight
   ;; `(default ((t (:background ,bg :foreground ,fg :font "Sarasa Term SC-14"))))
   `(default ((t (:background ,bg :foreground ,fg :font "Iosevka Term Slab-11"))))
   `(fringe ((t (:background ,bg))))
   '(Mode-line-inactive ((t (:inherit mode-line))))
   '(region ((t (:background "#beeb9f"))))
   '(highlight ((t (:background "forest green"))))
   '(link ((t (:foreground "royal blue" :underline t))))
   `(show-paren-match ((t (:foreground ,fg :background "cyan"))))
   ...
   '(font-lock-string-face ((t (:foreground "#36175e"))))
   ...
   `(org-agenda-done ((t (:foreground ,fg))))
